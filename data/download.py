...
def load_dataset(benchmark, datapath, thres, split='test', cam='', img_side=(256, 256), use_resize=False, use_batch=False):
    ...
    return dataset(benchmark, datapath, thres, split, cam, img_side, use_resize, use_batch)
