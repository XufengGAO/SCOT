...
def load_dataset(benchmark, datapath, thres, split='test', cam='', output_image_size=(256, 256), use_resize=False, use_batch=False):
    ...
    return dataset(benchmark, datapath, thres, split, cam, output_image_size, use_resize, use_batch)
